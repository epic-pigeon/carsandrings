...
public class EnemyRealWheel : MonoBehaviour
{
        ...
        for (int i = 0; i < wheels.Length; ++i)
        {
            ...
            if (wheelShape != null)
            {
                ...
                if (wheel.transform.localPosition.x < 0f)
                {
                    ...
                    ws.transform.localScale = new Vector3((-1) * ws.transform.localScale.x, ws.transform.localScale.y, ws.transform.localScale.z);
                }
            }
        }
    }
